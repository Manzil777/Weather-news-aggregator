...
const Header = () => {
    ...
    return (
        <header className="p-6 md:p-8 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-slate-900 transition-colors duration-300">
            <nav className="flex justify-between items-center">
                <Link to="/" className="flex flex-col">
                    <img src="/logo.png" alt="NW Aggregator" className="h-28 w-auto object-contain" />
                </Link>
                ...
                <div className="hidden lg:flex items-center space-x-8">
                    ...
                    <Link to="/weather" className={`text-sm transition-colors ${isActive('/weather')}`}>
                        Weather
                    </Link>
                    <Link to="/saved" className={`text-sm transition-colors ${isActive('/saved')}`}>
                        Saved
                    </Link>
                </div>
